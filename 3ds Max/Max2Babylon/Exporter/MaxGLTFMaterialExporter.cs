...
{
    //private Dictionary<ClassIDWrapper, IBabylonMaterialExtensionExporter> materialExporters;
    ...
    //    this.materialExporters = new Dictionary<ClassIDWrapper, IBabylonMaterialExtensionExporter>();
    //    foreach (Type type in Tools.GetAllLoadableTypes())
    //    {
    //        if (type.IsAbstract || type.IsInterface || !typeof(IBabylonMaterialExtensionExporter).IsAssignableFrom(type))
    //            continue;
