...
namespace Max2Babylon
{
    ...
    public class FlightSimMaterialExporter : IMaxMaterialExporter
    {
        [DataContract]
        ...
        public object ExportGLTFExtension<T1>(T1 babylonObject, ExportParameters parameters, GLTF gltf, ILoggingProvider logger)
        {
